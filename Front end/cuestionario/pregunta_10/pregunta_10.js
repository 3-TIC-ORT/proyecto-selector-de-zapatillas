...
if (siguiente) {
    siguiente.addEventListener("click", () => {
        ...
        if (seleccionada.value === "A") {
            ...
            postEvent("respuestaPregunta10", { opcion: "A" })
        }
        if (seleccionada.value === "B") {
            window.location.href = "../pregunta_2/pregunta_2.html"; 
            postEvent("respuestaPregunta10", { opcion: "B" })
        }
        if (seleccionada.value === "C") {
            window.location.href = "../pregunta_2/pregunta_2.html"; 
            postEvent("respuestaPregunta10", { opcion: "C" })
        }

        if (seleccionada.value === "D") {
            window.location.href = "../pregunta_2/pregunta_2.html"; 
            postEvent("respuestaPregunta10", { opcion: "D" })
        }
